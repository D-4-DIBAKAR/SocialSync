...
export const getComments = async (req, res, next) => {
  try {
    ...
    // Use the correct case for the parameter name
    const postId = req.params.postId;
    console.log("Provided Post ID:", postId);
    ...
    // console.log("Retrieved Comments:", postComments);
